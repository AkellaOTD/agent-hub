...
| `/artifact plan-gpt.md` | Показать содержимое артефакта |
...
CLI вызовы могут занимать 30–120 секунд. Таймаут по умолчанию — 300 секунд. Если агент стабильно не отвечает:
