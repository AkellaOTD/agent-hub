...
ВАЖНО: НЕ создавай файлы на диске (планы, заметки и т.д.). Весь вывод — только через [ARTIFACT:filename] блоки внутри [CONCLUSION]. Не используй встроенные инструменты записи файлов.
"""
